...
export function QueueLockedBanner({
  ...
  if (isCompleted) {
    return (
      <div
        ...
        className="content-container sticky top-0 z-10 shadow-md transition-all duration-300
  ...
  return (
    <div
      ...
      data-testid="queue-locked-banner"
      className={`content-container sticky top-0 z-10 shadow-md transition-all duration-300 ${bgClass}`}
    >
      {/* Main row */}
